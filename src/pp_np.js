...
class Processo {
    ...
    constructor(numero, TC, TS1, tempoEspera, TS2, prioriadade1, prioriadade2){
        this.nome = 'P' + numero;
        this.TC = TC;
        this.TS1 = TS1;
        this.TS2 = TS2;
        this.tempoEspera = tempoEspera;
        this.prioriadade1 = prioriadade1;
        this.prioriadade2 = prioriadade2;
    }
    ...
    prioriadade() {
        if(this.completouTS1) {
            return this.prioriadade2;
        }
        return this.prioriadade1;
    }
...
function verificaProntos() {
    ...
    if(!procInCPU){
        ...
        procInCPU = filaProntos.reduce(function(ante, atual) {
            return ante.prioriadade() <= atual.prioriadade() ? ante : atual;
        });
...
function mostraFilaNovos() {
    ...
    for(let i = 0; i < filaNovos.length; i++) {
        ...
        td = document.createElement('td');
        texto = document.createTextNode(filaNovos[i].prioriadade1);  
        td.appendChild(texto);
        tr.appendChild(td);
        ...
        td = document.createElement('td');
        texto = document.createTextNode(filaNovos[i].prioriadade2);  
        td.appendChild(texto);
        tr.appendChild(td);
...
function mostraFilaProntos() {
    ...
    for(let i = 0; i < filaProntos.length; i++) {
        ...
        td = document.createElement('td');
        texto = document.createTextNode(filaProntos[i].prioriadade());  
        td.appendChild(texto);
        tr.appendChild(td);
        listaProntos.appendChild(tr);    
    }
...
document.getElementById("addButton").onclick = function() {
    ...
    let novoPrioriadade1 = +document.getElementById("novoPrioridade1").value;
    let novoIO = +document.getElementById("novoIO").value;
    let novoTS2 = +document.getElementById("novoTS2").value;
    let novoPrioriadade2 = +document.getElementById("novoPrioridade2").value;
    

    let novoProc = new Processo(nameCounter, novoTC, novoTS1, novoIO, novoTS2, novoPrioriadade1, novoPrioriadade2);
